...
class _NumConstants:
    ...
    """Table of suffixes* and associated numerican values"""

    suffixes: Final[List[str]] = [
        "", "K", "M", "B", "T", "Qa", "Qu", "S", "Oc", "No",
    ...
    sci_expr: Final[List[float]] = [
        1e0, 1e3, 1e6, 1e9, 1e12, 1e15, 1e18, 1e21, 1e24, 1e27,
...
def numerize(n, decimal=2):
    #60 sufixes
    sufixes =  _NumConstants.suffixes
    sci_expr = _NumConstants.sci_expr
